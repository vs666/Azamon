...
VALUES ("PUMAF99", 1000, "PUMA", "Puma-Frazer99_Shoes");
INSERT INTO PRODUCTS (ProductID, Price, Brand, Product_name)
VALUES (
        "ADI2010",
        100,
        "Adiboss",
        "Adiboss_Sports-Shoes"
    );
INSERT INTO PRODUCTS (ProductID, Price, Brand, Product_name)
VALUES (
        "Nimbus2000",
...
VALUES (
        ...
        1500,
        "Adidas",
        "Barca-edition_Football"
    );
INSERT INTO PRODUCTS (ProductID, Price, Brand, Product_name)
VALUES ("MacAir", 83000, "Apple", "Mac-Book_Air");
INSERT INTO PRODUCTS (ProductID, Price, Brand, Product_name)
VALUES ("S434K", 93000, "Sony", "Sony_43in_4K-plasmaTV");
INSERT INTO PRODUCTS (ProductID, Price, Brand, Product_name)
...
VALUES (
        ...
        1100,
        "Nike",
        "Lewandoski-edition_Bayern-Jersey"
    );
INSERT INTO PRODUCTS (ProductID, Price, Brand, Product_name)
VALUES (
        "OneP_se",
...
INSERT INTO PAYMENT_MODE (Mode,Company) VALUES ("OnlineBanking","Amazon Pay");
INSERT INTO PAYMENT_MODE (Mode,Company) VALUES ("OnlineBanking","PayTM");
INSERT INTO PAYMENT_MODE (Mode,Company) VALUES ("Debit Card","StateBankofIndia");
INSERT INTO PAYMENT_MODE (Mode,Company) VALUES ("CashOnDelivery","NoCompany");
INSERT INTO PAYMENT_MODE (Mode,Company) VALUES ("OnlineBanking","StateBankofIndia");
